        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="flex flex-col gap-4">
            <Link href="/" className="flex items-center gap-3 group">
              <img src="/logo.jpg" alt="Surah Yaseen Logo" className="w-10 h-10 rounded-full object-cover border border-caribbean-green/20 shadow-md shadow-caribbean-green/10 transition-transform group-hover:scale-105 duration-300" />
